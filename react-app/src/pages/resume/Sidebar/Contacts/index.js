        ...
        <div>
            ...
            <ul className="text-xs flex flex-col gap-y-3">
                ...
                <li className="flex align-middle gap-x-1">
                    ...
                    <a href='https://github.com/lucianobragaweb' target='_blank' rel="noreferrer">github.com/robsu17</a>
                </li>
                <li className="flex align-middle gap-x-1">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <li className="flex align-middle gap-x-1">
                    ...
                    <a href='https://www.linkedin.com/in/robson-lima-ba5bb31a8' target='_blank' rel="noreferrer">Robson Lima</a>
                </li>
            </ul>
        </div>
    )
