...
export default function Footer () {
    ...
    return (
        <footer className="py-4 px-4 flex flex-col md:flex-row text-xs justify-center space-x-4  align-middle mx-auto max-w-screen-md border-t border-neutral-200">
            <div className='text-neutral-400 justify-center align-middle py-4 text-center'>
            ...
            <div className='flex space-x-1 md:py-4'>
