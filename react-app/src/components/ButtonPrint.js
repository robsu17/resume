export default function ButtonPrint (props) {
    ...
    return (
        <button onClick={ print } id={ props.id } className={`${ props.id } absolute right-0 p-1 hover:bg-neutral-700 text-neutral-700 hover:text-white focus:outline-none border-2 border-neutral-700 rounded-full`}>
